...
class DashboardLogicAdapterV1 implements DashboardLogicAdapter {
  ...
  @override
  String formatPercentage(double value, double total) => _logic.formatPercentage(value, total);
  ...
  @override
  List<TransactionItem> getIncomeTransactions() => _logic.getIncomeTransactions();
  
  @override
  List<TransactionItem> getExpenseTransactions() => _logic.getExpenseTransactions();
...
class DashboardLogicAdapterV2 implements DashboardLogicAdapter {
  ...
  @override
  bool get shouldShowExpensesChart => _logic.hasExpenses && _logic.expensesByCategory.isNotEmpty;
