...
class _QuickAddCategoryContent extends StatefulWidget {
  ...
  @override
  State<_QuickAddCategoryContent> createState() => _QuickAddCategoryContentState();
}
                ...
                child: LayoutBuilder(
                  builder: (BuildContext context, BoxConstraints constraints) {
                    ...
                    final EdgeInsets gap =
                        vertical ? const EdgeInsets.only(top: 12) : const EdgeInsets.only(left: 12);
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              onChanged: (String? v) => setState(() => _tipo = v ?? 'ingreso'),
                          ...
                          BlocConsumer<CategoriesBloc, CategoriesState>(
                            ...
                            builder: (BuildContext context, CategoriesState state) => SizedBox(
                              width: 120,
                                ...
                                onPressed: state.loading
                                    ...
                                    : () {
                                        ...
                                        context.read<CategoriesBloc>().add(
                                              CategoryCreate(_nameCtrl.text.trim(), _tipo),
                                            );
                                      },
                                icon: state.loading
                                    ? const SizedBox(
