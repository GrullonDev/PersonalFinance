...
class _PrivacyPolicyPageState extends State<PrivacyPolicyPage> {
  ...
  Future<void> _loadPrivacyPolicy() async {
    try {
      final String content = await rootBundle.loadString('assets/privacy_policy.md');
      setState(() {
  ...
  Widget _buildActionButtons(BuildContext context, ColorScheme colorScheme, bool isDarkMode) {
    return Column(
      children: <Widget>[
        // Botón de contacto
        SizedBox(
