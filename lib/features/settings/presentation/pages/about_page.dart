...
class AboutPage extends StatelessWidget {
  ...
  Widget _buildAppIdentity(ColorScheme colorScheme, ThemeData theme) {
    return Column(
      children: [
        Container(
          width: 100,
      ...
      child: Column(
        children: [
          _buildInfoItem(
            icon: Icons.public,
            title: 'Sitio Web',
            onTap: () => _launchUrl('https://github.com/GrullonDev'),
          ),
          _buildInfoItem(
  ...
  Widget _buildBrandFooter(ColorScheme colorScheme, ThemeData theme) {
    return Column(
      children: [
        Text(
