...
import 'package:personal_finance/features/budgets/models/budget_models.dart';
...
class BudgetsLogic extends ChangeNotifier {
  ...
  List<BudgetAlert> alerts = <BudgetAlert>[
    BudgetAlert(category: 'Comida', threshold: 90, enabled: true),
    BudgetAlert(category: 'Transporte', threshold: 85, enabled: false),
    BudgetAlert(category: 'Ocio', threshold: 95, enabled: true),
  ];

  void toggleAlert(String category, bool value) {
